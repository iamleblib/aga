                            ...
                            <div class="mb-4" data-kt-search-element="main">
                                ...
                                <div class="scroll-y mh-200px mh-lg-325px">
                                    ...
                                    <div class="d-flex align-items-center mb-5">
                                        ...
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column">
                                            <a href="{{ route('investment.index') }}" class="fs-6 text-gray-800 text-hover-primary fw-bold">Investments</a>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="d-flex align-items-center mb-5">
                                        ...
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column">
                                            <a href="{{ route('deposit.index') }}" class="fs-6 text-gray-800 text-hover-primary fw-bold">Deposits</a>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="d-flex align-items-center mb-5">
                                        ...
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column">
                                            <a href="{{ route('withdraw.index') }}" class="fs-6 text-gray-800 text-hover-primary fw-bold">Withdrawals</a>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="d-flex align-items-center mb-5">
                                        ...
                                        <!--begin::Title-->
                                        <div class="d-flex flex-column">
                                            <a href="{{ route('users.index') }}" class="fs-6 text-gray-800 text-hover-primary fw-bold">Manage Users</a>
                                        </div>
                                        <!--end::Title-->
                                    </div>
