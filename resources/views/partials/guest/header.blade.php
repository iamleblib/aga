...
<div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
    <a href="{{route('home')}}">
        <img alt="Logo" src="{{ asset('backend/assets/media/logos/logo.png') }}" width="50%" class="logo-default h-25px"/>
		<img alt="Logo" src="{{ asset('backend/assets/media/logos/logo.png') }}" class="logo-sticky h-25px">
	</a>
</div>
<!--end::Header Logo-->
<!--begin::Wrapper-->
