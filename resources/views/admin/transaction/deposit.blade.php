                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-end">
                                                ...
                                                @elseif($deposit->status == 'pending')
                                                    ...
                                                    <!--begin::Menu-->
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-9" data-kt-menu="true">
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
