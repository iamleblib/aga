    ...
    <div class="toolbar py-5 py-lg-15" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-white fw-bolder my-1 fs-3">All Withdrawal Transactions</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-white opacity-75">All Withdrawal</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table">
                                    ...
                                    @foreach($withdrawals as $withdrawal)
                                        <tr class="even">
                                            ...
                                            <!--begin::Name=-->
                                            <td>
                                                <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $withdrawal->user->username }}</a>
                                            </td>

                                            <td>
                                                <a href="#" class="text-gray-800 text-hover-primary mb-1 badge badge-light-success">{{ $withdrawal->ref }}</a>
                                            </td>
                                            <!--end::Name=-->
                                            <!--begin::Email=-->
                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary mb-1">${{ number_format($withdrawal->amount) }}</a>
                                            </td>

                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary badge @if($withdrawal->status == 'processed') badge-light-success @elseif($withdrawal->status == 'pending') badge-light-warning @elseif($withdrawal->status == 'declined') badge-light-danger @endif mb-1">{{ $withdrawal->status }}</a>
                                            </td>
                                            <!--end::Email=-->
                                            <!--begin::Company=-->
                                            ...
                                            <td class="text-end">
                                                ...
                                                @elseif($withdrawal->status == 'pending')
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a data-bs-toggle="modal" data-bs-target="#decline_{{ $withdrawal->id }}" class="menu-link px-3">Decline</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    </div>
                                                    <!--end::Menu-->
                                        ...
                                        <div class="modal fade" id="approve_{{ $withdrawal->id }}" tabindex="-1" aria-hidden="true">
                                            <!--begin::Modal dialog-->
                                                    ...
                                                    <div class="modal-body scroll-y pt-0 pb-15">
                                                        ...
                                                        <div class="mw-lg-600px mx-auto">
                                                            ...
                                                            <div class="mb-13 text-center">
                                                                <!--begin::Title-->
                                                                <h1 class="mb-3">Approve Withdrawal</h1>
                                                            </div>
                                                            <!--end::Heading-->
                                                            <!--begin::Input group-->
                                                            <form id="kt_modal_update_rolsse_form" class="form" method="post" action="{{ route('admin.withdraw.approve', $withdrawal->id) }}">
                                                                <!--begin::Notice-->
                                                                <!--begin::Notice-->
                                                                @csrf
                                        ...
                                        <div class="modal fade" id="decline_{{ $withdrawal->id }}" tabindex="-1" aria-hidden="true">
                                            <!--begin::Modal dialog-->
                                            <div class="modal-dialog modal-dialog-centered mw-800px">
                                                <!--begin::Modal content-->
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body scroll-y pt-0 pb-15">
                                                        ...
                                                        <div class="mw-lg-600px mx-auto">
                                                            ...
                                                            <div class="mb-13 text-center">
                                                                <!--begin::Title-->
                                                                <h1 class="mb-3">Decline Withdrawal</h1>
                                                            </div>
                                                            <!--end::Heading-->
                                                            <!--begin::Input group-->
                                                            <form id="kt_modal_update_rolsse_form" class="form" method="post" action="{{ route('admin.withdraw.decline', $withdrawal->id) }}">
                                                                <!--begin::Notice-->
                                                                <!--begin::Notice-->
                                                                @csrf
                                                                <div class="notice d-flex bg-light-danger rounded border-danger border border-dashed mb-9 p-6">
                                                                    ...
                                                                    <div class="d-flex flex-stack flex-grow-1">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-8">
                                                                                <div class="fw-bold">
                                                                                    <div class="fs-6 text-gray-700">Confirm you want to decline this withdrawal!.</div>
                                                                                </div>
                                                                            </div>
