        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form autocomplete="off" id="kt_modal_new_target_form" class="form" method="post" action="{{ route('users.add.process') }}">
                        @csrf
                        <!--begin::Heading-->
                        ...
                        <div class="row g-9 mb-8">
                            ...
                            <div class="d-flex flex-column col-6 fv-row">
                                ...
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Enter Fullname"></i>
                                </label>
                                <!--end::Label-->
                            ...
                            <div class="d-flex flex-column col-4 fv-row">
                                ...
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Enter E-mail Address"></i>
                                </label>
                                <!--end::Label-->
                            ...
                            <div class="d-flex flex-column col-4 fv-row">
                                ...
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Enter Phone Number"></i>
                                </label>
                                <!--end::Label-->
                            ...
                            <div class="d-flex flex-column col-4 fv-row">
                                ...
                                <!--end::Label-->
                                <select name="country" class="form-select form-select-solid" aria-label="Select example">
                            ...
                            <div class="d-flex flex-column col-6 fv-row">
                                ...
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Enter Password"></i>
                                </label>
                                <!--end::Label-->
                            ...
                            <div class="d-flex flex-column col-6 fv-row">
                                ...
                                <!--end::Label-->
                                <input type="password" class="form-control form-control-solid" placeholder="Enter Password again" name="password_confirmation" />
                            </div>
                        </div>
