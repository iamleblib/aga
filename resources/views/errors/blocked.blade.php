<html lang="en"><!--begin::Head--><!-- Mirrored from preview.keenthemes.com/metronic8/demo2/authentication/general/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Nov 2021 01:48:38 GMT --><!-- Added by HTTrack --><head><meta http-equiv="content-type" content="text/html;charset=UTF-8"><!-- /Added by HTTrack -->
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column flex-center flex-column-fluid p-10">
        <!--begin::Illustration-->
        <img src="{{ asset('backend/assets/media/illustrations/sigma-1/20.png') }}" alt="" class="mw-100 mb-10 h-lg-450px">
        <!--end::Illustration-->
        <!--begin::Message-->
        <h1 class="fw-bold mb-10" style="color: #A3A3C7">Your Account has been temporally blocked, Please Contact our support team</h1>
        <!--end::Message-->
        <!--begin::Link-->
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo2/authentication/general/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Nov 2021 01:48:39 GMT -->
