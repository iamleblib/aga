...
<div class="landing_wrapper breadcrumb_wrapper">
        <div class="wrapper breadcrumb_wrapper_content" style="background-image: url('{{ asset('front/img/about_bg.jpeg')}}'); background-size: cover ">
    ...
    <div class="wrapper blog_page_wrapper" style="background-image: url('{{ asset('front/img/faqs_breadcrumb_wrapper_content.png')}}')">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 order-lg-first order-md-last order-last">
                    <div class="blog_slidebar">
                        <div class="blog_sidebar_widget">
                            <h2 class="blog_sidebar_title">Email us</h2>
                            <form action="mailto:support@coinbaseassets.com" method="GET">
                                <input type="search" disabled value="support@coinbaseassets.com" required>
                                <button type="submit" class="btn_default"><i class="fa fa-envelope"></i></button>
                            </form>
                        </div>
                        <div class="blog_sidebar_widget">
                        ...
                        <div class="blog_sidebar_widget blog_sidebar_ad">
                            <span class="ad_bordered_title">Contact Us</span>
                            <p class="ad_subtitle">If You wish to give a call</p>
                            <a href="tel:+5376377837893" class="btn_default">Call Now <i class="fa fa-phone"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 order-lg-last order-md-first order-first">
                    <div class="blog_items">
                        <div class="single_blog_item">
                            <div class="blog_head">
                                <div class="blog_head_img">
                                    <div class="blog_img">
                                        <center><img class="rotate img-fluid" src="{{ asset('front/img/world.png')}}" width="400px" alt=""></center>
                                        <ul class="blog_date">
                                            <li>15th</li>
                                            <li>Aug</li>
                                            <li>2018</li>
                            ...
                            <div class="blog_info">
                                <p class="blog_status"><i class="fa fa-users text_colored"></i><span>About us</span></p>
                                <a class="blog_title" href="#">WHO WE ARE</a>
                        ...
                        <div class="single_blog_item">
                            <div class="blog_info">
                                <a class="blog_title" href="#">WHAT WE DO</a>
                                <div style="margin: -20px; !important"></div>
                                <img class="" src="{{ asset('front/img/Wrapper_title_divider.png')}}" aria-colcount="" alt="">
                                <p class="blog_desc">
                                    There is a path to invest in the market, and that is knowledge. Without any analysis or knowledge any individual cannot earn a
                                    capital profit, and for that, we introduce you to an opportunity which provides you with the complete performances
                                    regarding the elements such as forex, precious metal, natural resources, official bonds, stocks and updated market
                                    capital benefits.
                                    </p>
                                    <p class="blog_desc">
                                        Our team of experts who brings up to help an individual to understand the right endowment strategy to over-come unstable
                                        financial situations. Nevertheless, we share a grok platform.
                                    </p>
                                    <p class="blog_desc">
                                ...
                                <div class="container">
                                    <div class="row">
                                               ...
                                               <!-- Forex Trading -->
                                                ...
                                                <div class="modal fade" style="background: silver;" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content" style="background: grey; color: white">
                                                        ...
                                                        <h5 class="modal-title" id="exampleModalLongTitle">Forex Trading <img src="{{ asset('front/img/forex-trading.png')}}" alt="" width="70px"></h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            foreign trade and global business. The need to exchange currencies is the primary reason why the forex market is the largest,
                                                            most liquid financial market in the world. There are actually three ways that institutions, corporations, and individuals
                                                            trade forex assist: the spot market, the forward's market, and the future's market. The forex trading in the spot market which
                                                            always has been the largest market because it is the "underlying" real asset that the forward's and future's markets are based on.
                                                            The forward's and future's markets tend to be more popular with companies that need to hedge their foreign exchange risks out to a
                                        ...
                                        <div class="col-lg-3 p-2">
                                            <!-- stock Trading -->
                                                ...
                                                <div class="modal fade"  style="background: darkgrey" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content" style="background: grey; color: white">
                                                        <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLongTitle">Stock Trading <img src="{{ asset('front/img/stocks-trading.png')}}" alt="" width="70px"></h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            Investing in stocks is grok as online shopping, it can be financially rewarding if handled and taken care in the right way. <br>
                                                            Stocks investment is an opportunity for investors to create long-term wealth. But it definitely takes time to
                                                            understand and to make an individual, an independent stock investor. Regular analytic view on stocks, therefore
                                                            right investment strategies which advice us and reproduce more discussion with experts exponentially leads to a
                                                            great financial success. An individual doesn’t execute stock trades every day, indeed! monitor's the holdings
                                                            frequently and makes adjustments to create an appropriate portfolio. Stocks let you own a piece of a company’s future.
                                                            They’re available for a wide variety of industries—so you can tap into your knowledge of specific businesses, or buy a
                                        ...
                                        <div class="col-lg-3 p-2">
                                            ...
                                            <div class="modal fade"  style="background: darkgrey" id="exampleModalCenter3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                ...
                                                <div class="modal-content" style="background: grey; color: white">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">Cryptocurrency Trading <img src="{{ asset('front/img/cryptocurrency.png')}}" alt="" width="70px"></h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        Cryptocurrency trading is defined as buying and selling cryptocurrencies. It is very similar to Forex trading and
                                                        stock market trading. Trading can be done in futures, options and cash. It bears some similarities to foreign
                                                        exchange (forex), where fiat currencies from across the globe are traded 24 hours a day. CBA provides a
                                                        world class platform for trading and mining of Futures on bitcoin and altcoins such as ether, litecoin and ripple
                                        ...
                                        <div class="col-lg-3 p-2">
                                            ...
                                            <div class="modal fade"  style="background: darkgrey" id="exampleModalCenter4" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                ...
                                                <div class="modal-content" style="background: grey; color: white">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">Precious Metal <img src="{{ asset('front/img/precious-metals.png')}}" alt="" width="70px"></h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p>
                                                            The reason to invest in precious metals is that they are extracted in a very limited quantity every year, this is
                                                            due to the scarcity of these like raw resources in nature. Political crises and wars etc. cause investors to seek the
                                                            stability of precious metals. Physical metals are particularly attractive in these situations since they are valuable
                                                            items that you can keep in your own possession for greater security asset. The safest portfolio is one that is
                                                            well-diversified. By having investments in precious metals an individual can garner profits while protecting themselves
                                                            from losses. The three major precious metals that trade on futures exchanges around the world are gold, silver, and platinum.
                                                        </p>
                                                        <br>
                                                        <p>Gold has the benefit of being a durable metal that has, historically, kept its appeal. Investors in the precious
                                                            metals market go back and forth on silver, alternately valuing it as a store of value and a metal with tangible
                                                            industrial uses. For this reason, its value is more volatile than golds. However, because silver is lower in price,
                                                            it is easier for the beginner to get started Investing in platinum helps in diversifying an investment portfolio, and
                                                            also provide a smart long-term investment strategy. It has a very short financial trading history associated with it
                                    ...
                                    <div class="col-lg-4 p-2">
                                        ...
                                        <div class="modal fade"  style="background: darkgrey" id="exampleModalCenter5" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="modal-content" style="background: grey; color: white">
                                                <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Crude Oil <img src="{{ asset('front/img/crude-oil.png')}}" alt="" width="70px"></h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                                </div>
                                ...
                                <div class="col-lg-4 p-2">
                                    ...
                                    <div class="modal fade"  style="background: darkgrey" id="exampleModalCenter6" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        ...
                                        <div class="modal-content" style="background: grey; color: white">
                                            <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Natural Gas <img src="{{ asset('front/img/natural-gas.png')}}" alt="" width="70px"></h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>
                            ...
                            <div class="col-lg-4 p-2">
                                    ...
                                    <div class="modal fade"  style="background: darkgrey" id="exampleModalCenterEstate" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        ...
                                        <div class="modal-content" style="background: grey; color: white">
                                            <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Real Estate <img src="{{ asset('front/img/real-estate.png')}}" alt="" width="30px"></h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>
                        ...
                        <div class="single_blog_item">
                            ...
                            <div class="blog_info">
                                ...
                                <img class="" src="{{ asset('front/img/Wrapper_title_divider.png')}}" aria-colcount="" alt="">
                                <p class="blog_desc">
                                    We nourish and aim to work hard to become the fastest leading investor's company and an online platform to provide an
                                    opportunity to take out of mesh from the unsuccessful flows.
                        ...
                        <div class="single_blog_item align-left">
                            ...
                            <div class="blog_info">
                                ...
                                <img class="" src="{{ asset('front/img/Wrapper_title_divider.png')}}" aria-colcount="" alt="">
                                <p class="blog_desc">
                                    Our vision is to create an awareness among the opportunity to invest and make our investors understand the
                                    marvellous hygienic trading world. Also to acknowledge them about, how important is decision making in choosing
                                    an accurate and right investment platform.
                                    </p>
                            </div>
                        </div>
