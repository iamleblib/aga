                    ...
                    <div class="mw-lg-950px mx-auto w-100">
                        ...
                        <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                            ...
                            <div class="text-sm-end">
                                <!--begin::Logo-->
                                <a href="#">
                                    <img alt="Logo" width="10%" src="{{ asset('backend/assets/media/logos/logo-stick.png')}}">
                                </a>
                                <!--end::Logo-->
                                <!--begin::Text-->
                        ...
                        <div class="d-flex flex-stack flex-wrap mt-lg-20 pt-13">
                            ...
                            <form action="{{ route('deposit.process') }}" method="post">
                                <div class="row">
                                    ...
                                    <!-- begin::Action-->
                                    <button type="submit" class="btn btn-success my-1">I've Paid <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
