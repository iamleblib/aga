                ...
                <div class="card-body pt-9 pb-0">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                            ...
                                            <!--end::Svg Icon-->
                                            <a href="{{ auth()->user()->credential->facebook ?? '' }}"  target="_blank" class="d-flex align-items-center text-primary-400 text-hover-primary mb-2">
                                        ...
                                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                            ...
                                            <span class="svg-icon svg-icon-4 me-1"></span>
                                            <!--end::Svg Icon-->
                                            <a target="_blank" href="{{ auth()->user()->credential->instagram ?? '' }}" class="d-flex align-items-center text-danger text-hover-primary mb-2">
                                        ...
                                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                            ...
                                            <span class="svg-icon svg-icon-4 me-1"></span>
                                            <!--end::Svg Icon-->
                                            <a target="_blank" href="{{ auth()->user()->credential->twitter ?? '' }}" class="d-flex align-items-center text-primary-400 text-hover-grey mb-2">
                    ...
                    <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 active" data-bs-toggle="tab" href="#Overview">Overview
                        ...
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab"  href="#Billing">Billing
                    ...
                    <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab"  href="#Referrals">Referrals
