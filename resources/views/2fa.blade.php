                ...
                @csrf
                    ...
                    <div class="mb-10 px-md-10">
                        ...
                        <div class="d-flex flex-wrap flex-stack">
                            <input type="password" data-inputmask="'mask': '9', 'placeholder': ''" maxlength="1" name="code1" class="form-control form-control-solid h-60px w-60px fs-2qx text-center border-primary border-hover mx-1 my-2" />
                            <input type="password" data-inputmask="'mask': '9', 'placeholder': ''" maxlength="1" name="code2" class="form-control form-control-solid h-60px w-60px fs-2qx text-center border-primary border-hover mx-1 my-2" />
                            <input type="password" data-inputmask="'mask': '9', 'placeholder': ''" maxlength="1" name="code3" class="form-control form-control-solid h-60px w-60px fs-2qx text-center border-primary border-hover mx-1 my-2" />
                            <input type="password" data-inputmask="'mask': '9', 'placeholder': ''" maxlength="1" name="code4" class="form-control form-control-solid h-60px w-60px fs-2qx text-center border-primary border-hover mx-1 my-2" />
                        </div>
                        <!--begin::Input group-->
                    </div>
                    <!--end::Section-->
